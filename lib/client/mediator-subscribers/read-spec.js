...
describe("Workorder Read Mediator Topic", function() {
  ...
  var syncReadTopic = "wfm:sync:read:workorders";
  var doneSyncReadTopic = "done:wfm:sync:read:workorders:workorderid";
  var errorSyncReadTopic = "error:wfm:sync:read:workorders:workorderid";
