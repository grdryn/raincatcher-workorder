...
function createTopic(topicOptions) {
  ...
  var topic = formatString(topicOptions.template || CONSTANTS.WORKORDER_TOPIC_TEMPLATE, topicOptions);
...
module.exports.errorTopic = function generateErrorMediatorTopic(topicOptions) {
  topicOptions.template = CONSTANTS.WORKORDER_ERROR_TOPIC_TEMPLATE;
...
module.exports.doneTopic = function generateDoneMediatorTopic(topicOptions) {
  topicOptions.template = CONSTANTS.WORKORDER_DONE_TOPIC_TEMPLATE;
  return createTopic(topicOptions);
};
